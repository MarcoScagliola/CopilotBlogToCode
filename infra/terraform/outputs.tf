...
output "databricks_workspace_url" {
  description = "Databricks workspace URL used by the deploy bridge to set DATABRICKS_HOST."
  value       = azurerm_databricks_workspace.main.workspace_url
}

output "databricks_workspace_resource_id" {
  description = "Full Azure resource ID of the Databricks workspace. Required for Azure SP auth in deploy_dab.py."
...
output "bronze_catalog" {
  description = "Unity Catalog catalog name for Bronze layer."
  value       = local.catalogs["bronze"]
}

output "silver_catalog" {
  description = "Unity Catalog catalog name for Silver layer."
  value       = local.catalogs["silver"]
}

output "gold_catalog" {
  description = "Unity Catalog catalog name for Gold layer."
  value       = local.catalogs["gold"]
}

output "bronze_schema" {
  description = "Unity Catalog schema name for Bronze layer."
  value       = local.schemas["bronze"]
}

output "silver_schema" {
  description = "Unity Catalog schema name for Silver layer."
  value       = local.schemas["silver"]
}

output "gold_schema" {
  description = "Unity Catalog schema name for Gold layer."
...
# ---------------------------------------------------------------------------
# Per-layer access connector IDs
# ---------------------------------------------------------------------------

output "bronze_access_connector_id" {
  description = "Resource ID of Bronze Databricks access connector."
  value       = azurerm_databricks_access_connector.layer["bronze"].id
}

output "silver_access_connector_id" {
  description = "Resource ID of Silver Databricks access connector."
  value       = azurerm_databricks_access_connector.layer["silver"].id
}

output "gold_access_connector_id" {
  description = "Resource ID of Gold Databricks access connector."
...
output "layer_access_connector_ids" {
  description = "Map of layer name to access connector resource ID. Used by the deploy bridge OPTIONAL_MAP_KEYS resolution."
  value = {
    for layer in toset(["bronze", "silver", "gold"]) :
...
# ---------------------------------------------------------------------------
# Bridge-compatible alias outputs
# ---------------------------------------------------------------------------

output "bronze_catalog_name" {
  description = "Alias for bronze_catalog used by deploy bridge fallback key resolution."
  value       = local.catalogs["bronze"]
}

output "silver_catalog_name" {
  description = "Alias for silver_catalog used by deploy bridge fallback key resolution."
  value       = local.catalogs["silver"]
}

output "gold_catalog_name" {
  description = "Alias for gold_catalog used by deploy bridge fallback key resolution."
  value       = local.catalogs["gold"]
}

output "secret_scope_name" {
  description = "Alias for secret_scope used by deploy bridge fallback key resolution."
  value       = local.secret_scope_name
}
