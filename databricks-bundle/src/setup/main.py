"""Setup job scaffold for medallion resources.

Logs the layer wiring and parameter contract; replace with real Unity Catalog
provisioning statements for catalogs/schemas/external locations.
"""
