    ...
    steps:
      ...
      - name: Terraform Apply
        ...
        run: |
          ...
          if [ $rc -ne 0 ]; then
            if grep -q "SoftDeletedVaultDoesNotExist" /tmp/tf-apply.log; then
            ...
            elif grep -q "automatically recovering this KeyVault has been disabled" /tmp/tf-apply.log; then
