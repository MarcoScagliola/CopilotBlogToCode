...
1. Execute the skill end-to-end.
2. Generate or refresh all expected artifacts (`SPEC.md`, `TODO.md`, Terraform, Databricks bundle, workflows, and plan prompt).
3. Validate outputs with Python compile checks, Terraform init/validate, YAML parsing, and environment/placeholder checks.
4. Summarize results with pass/fail and list any blockers.
5. Remove temporary files or artifacts that are not part of the expected output.
