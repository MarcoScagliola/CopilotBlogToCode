...
- Fetch timestamp: 2026-05-13-141847
...
- Bundle parity checks: passed (deploy bridge --var set matches bundle variable declarations and required-set constraints).
- Handler coverage checks: passed (key vault import handling, already-exists branch, fallback branch).
